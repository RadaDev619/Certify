...
const Navbar = () => {
  ...
  return (
    <div className='px-16 py-4 flex w-full justify-between items-center' style={{ backdropFilter: 'blur(10px)' }}> 
      <div className='absolute inset-0 bg-[#D9D9D9] opacity-[45%] backdrop-blur-sm' /> {/* Background element */}
