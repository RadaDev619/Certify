        ...
        {fetchedData && (
          <div className="mt-5 mr-56 flex">
            <div className="text-5xl flex justify-center ">
              <h1>Certificate valid</h1>
            </div>
            <div
              className="w-8/12 p-8 bg-center bg-no-repeat"
              style={{ backgroundImage: `url(${backgroundImage})` }}
            >
              <div className="p-10 text-left flex flex-col">
                ...
                <div className="flex translate-x-[250px] pt-10 gap-2">
                  <p>Course duration:</p>
                  <p>{fetchedData.coursePeriod}</p>
                </div>
                <div className="flex translate-x-[250px] pt-2 gap-2">
                  <p>Course detail:</p>
                  <p>{fetchedData.courseDetails}</p>
                </div>
                <div className="flex translate-x-[250px] pt-2 gap-2 flex-col">
                  <p>ID:</p>
                  <p
                    className="break-all"
                    dangerouslySetInnerHTML={{ __html: insertWbr(ID, 8) }}
                  ></p>
                </div>
                <div className="flex translate-x-[250px] pt-2 gap-2">
                  <p>Issue date :</p>
