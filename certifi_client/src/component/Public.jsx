...
{/* search  */}
      ...
      <h1 className="pt-20 text-center text-xl font-bold uppercase">why choose us  </h1>
      ...
      <footer className="bg-white py-16 mt-20">
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            ...
            <p className="text-gray-600 mt-4 text-sm">Copyright © 2020 Logolpsum. All rights reserved.</p>
          </div>
          ...
          <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-16">
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-600 hover:text-gray-800 transition duration-300 ease-in-out">Email Marketing</a></li>
                <li><a href="#" className="text-gray-600 hover:text-gray-800 transition duration-300 ease-in-out">Campaigns</a></li>
                <li><a href="#" className="text-gray-600 hover:text-gray-800 transition duration-300 ease-in-out">Branding</a></li>
                <li><a href="#" className="text-gray-600 hover:text-gray-800 transition duration-300 ease-in-out">Offline</a></li>
              </ul>
            </div>
            <div>
              <h3 className="text-lg font-medium text-gray-800 mb-4">About</h3>
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-600 hover:text-gray-800 transition duration-300 ease-in-out">Our Story</a></li>
                <li><a href="#" className="text-gray-600 hover:text-gray-800 transition duration-300 ease-in-out">Benefits</a></li>
                <li><a href="#" className="text-gray-600 hover:text-gray-800 transition duration-300 ease-in-out">Team</a></li>
                <li><a href="#" className="text-gray-600 hover:text-gray-800 transition duration-300 ease-in-out">Careers</a></li>
              </ul>
            </div>
          </div>
